...
T2_DEFENSE_LADDER = [
    ...
    # ★ V11 [05-05]: T1 단일 진입 사다리 (T2_DEFENSE_LADDER 명칭은 호환용, T1에 적용)
    (-0.7, -0.4, "SL"),       # worst ≤ -0.7% + max ≥ -0.4% 도달 → 전량 cut
    (-0.9, -0.7, "SL"),       # worst ≤ -0.9% + max ≥ -0.7% 도달 → 전량 cut
    (-1.0, None, "HARD_SL"),  # worst ≤ -1.0% → 즉시 전량 cut
]
...
HARD_SL_BY_TIER = {1: -1.0}  # ★ V11 [05-05]: 사다리 -1.0% HARD_SL과 일관 (사다리 backup 역할)
