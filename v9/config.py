...
VERSION = "10.27b"  # ★ 서버 확인용: grep VERSION v9/config.py
...
# ★ V10.27: HARD_SL tier별 고정값 (ATR 스케일링/MR 압력 제거)
# T3/T4 타이트: MR 실패 빠르게 인정
HARD_SL_BY_TIER = {1: -7.0, 2: -7.0, 3: -4.0, 4: -3.0}
