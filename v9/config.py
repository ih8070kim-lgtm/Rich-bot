...
T2_DEFENSE_LADDER = [
    ...
    (-2.0, -0.5, "SL"),
    (-2.5, -1.5, "SL"),
    (-3.0, -2.5, "SL"),       # ★ V10.31AO-hf9 [05-02]: 추가 단계
    (-3.5, None, "HARD_SL"),  # ★ V10.31AO-hf9 [05-02]: -3.0 → -3.5
]
...
HARD_SL_BY_TIER = {1: -3.8, 2: -3.5}  # ★ V10.31AO-hf9 [05-02]: T2 -3.0→-3.5 (사다리 5단 -3.5 HARD_SL과 일관)
