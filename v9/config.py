...
# DD 셧다운
# ═══════════════════════════════════════════════════════════════════
DD_SHUTDOWN_THRESHOLD = -0.03   # ★ v10.6: 2%→3% (헷지 수익 시간 확보)
...
DCA_WEIGHTS = [30, 20, 20, 15, 15]  # ★ v10.12: 백테스트 최적 (순PnL +$588, MDD -4.46%)

DCA_LIMIT_TIMEOUT_SEC = 60
DCA_MIN_CORR          = 0.5

# ★ v10.8: 5단 쿨다운
DCA_COOLDOWN_BY_TIER = {2: 600, 3: 600, 4: 900, 5: 1200}
...
# Universe ASYM v2
# ═══════════════════════════════════════════════════════════════════
UNIVERSE_MIN_CORR        = 0.50   # ★ v10.11b: 0.60→0.50 (베타 필터가 커버, 유니버스 안정화)
UNIVERSE_MAX_CORR        = 0.96   # ★ v10.9: 0.92→0.96 (급등/급락 동조화 시 유니버스 비는 문제 해결)
UNIVERSE_CORR_WHITELIST  = {"ETH/USDT", "SOL/USDT", "BNB/USDT", "LINK/USDT"}  # ★ BNB/LINK 추가
UNIVERSE_VOL_MIN_USD     = 5_000_000   # ★ v10.6: $10M→$5M (SHORT_ONLY 소형알트 풀 확대)
UNIVERSE_TOP_N           = 16
UNIVERSE_EXCLUDE_TOP_ATR = 0      # ★ v10.11b: ATR 1위 포함 (베타 필터가 커버)
UNIVERSE_LONG_N          = 8
UNIVERSE_SHORT_N         = 8
